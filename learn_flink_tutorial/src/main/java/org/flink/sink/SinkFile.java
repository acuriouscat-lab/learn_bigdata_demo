    ...
    public static void main(String[] args) throws Exception {
        ...
        DataGeneratorSource<String> dataGeneratorSource = new DataGeneratorSource<>(new GeneratorFunction<Long,String>() {
            ...
            public String map(Long value) throws Exception {
                ...
                , Types.STRING);
        DataStreamSource<String> dataGenDS = env.fromSource(dataGeneratorSource, WatermarkStrategy.noWatermarks(), "genSource");
        dataGenDS.print("dataGenDS");
        FileSink<String> fileSink = FileSink
                ...
                .withRollingPolicy(DefaultRollingPolicy.builder()
                        .withInactivityInterval(Duration.ofMinutes(10L))
                        .withMaxPartSize(new MemorySize(1024))
                        .build())
                .build();

        dataGenDS.sinkTo(fileSink);
